      ...
      <div class="recorder-content">
            ...
            <el-scrollbar height="200px">
              ...
              >
                <div class="flex items-center">
                  <span
                    class="mr-2 text-xs bg-gray-200 rounded-full w-5 h-5 flex items-center justify-center"
                    >{{ index + 1 }}</span
                  >
                  <div>
        ...
        <div v-if="recordingCompleted" class="completed-status">
          <div class="text-center mb-4">
            ...
            <div class="text-sm text-gray-500">成功捕获 {{ capturedActions.length }} 个操作</div>
          </div>
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <div v-if="!isRecording && !recordingCompleted">
            ...
            <el-button type="primary" :disabled="!targetUrl" @click="startRecording">
              开始录制
            </el-button>
          </div>
          ...
          <!-- 录制中的按钮 -->
          <div v-if="isRecording && !recordingCompleted">
            <el-button type="danger" @click="stopRecording"> 结束录制 </el-button>
          </div>

          <!-- 录制完成的按钮 -->
          <div v-if="recordingCompleted">
            <el-button @click="handleCancel">取消</el-button>
            <el-button type="success" @click="generateFlow"> 生成流程 </el-button>
          </div>
        </div>
      </template>
    </el-dialog>
...
<script setup lang="ts">
  ...
  import {
    ...
    RecordActionType,
    RecordAction,
  } from '@/core/recorder/IntelligentRecorder'
