<template>
  <div class="space-y-4">
    ...
    <el-form-item label="输入设置">
      <div class="space-y-2">
        <el-checkbox v-model="node.properties.clearFirst" @change="handleChange">
          清除原有内容
        </el-checkbox>

        <el-checkbox v-model="node.properties.simulateTyping" @change="handleChange">
          模拟真实输入
        </el-checkbox>
    ...
    <el-form-item label="等待设置">
      <div class="space-y-2">
        <el-checkbox v-model="node.properties.waitAfterInput" @change="handleChange">
          输入后等待
        </el-checkbox>
