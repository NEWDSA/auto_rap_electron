<template>
  <el-dialog v-model="visible" title="自定义 AI 模型管理" width="70%" @close="handleClose">
      ...
      >
        <el-form :model="modelForm" label-width="100px">
          ...
          <el-form-item label="模型标识" required>
            <el-input v-model="modelForm.model" placeholder="如：llama3, qwen2.5, glm-4" />
          </el-form-item>
          ...
          <el-form-item v-if="modelForm.provider !== 'custom'" label="温度">
          ...
          <el-form-item v-if="modelForm.provider === 'custom'" label="自定义头部">
            <el-input
          ...
          <el-form-item v-if="modelForm.requestFormat === 'custom'" label="请求模板">
            <el-input
          ...
          <el-form-item v-if="modelForm.requestFormat === 'custom'" label="响应路径">
            <el-input
