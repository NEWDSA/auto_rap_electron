  ...
  <div class="space-y-4">
    ...
    <div class="space-y-2">
      ...
      <div class="flex items-center space-x-2">
        <el-input v-model="config.target" placeholder="点击选择目标元素" readonly class="flex-1" />
    ...
    <div v-if="config.action === 'type'" class="space-y-2">
      ...
      <el-input v-model="config.text" type="textarea" :rows="3" placeholder="请输入要输入的文本" />
    </div>
    ...
    <div v-if="config.action === 'press'" class="space-y-2">
      ...
      <p class="text-xs text-gray-500 dark:text-gray-400">例如：Control+C、Control+V、Alt+Tab 等</p>
    </div>
